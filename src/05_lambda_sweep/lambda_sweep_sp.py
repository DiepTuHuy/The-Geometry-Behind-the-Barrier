...
"""
============================================================================
 run_lambda_sweep_sp.py  --  NHAN CHAY LA XONG, KHONG SUA GI
============================================================================
     python run_lambda_sweep_sp.py
============================================================================

KHAC BAN CU O DIEM NAO (chi 3 diem, phan tinh toan GIU NGUYEN 100%):
  1. TU KHOI PHUC CSV: dau moi lan chay, script tu copy
     /kaggle/input/datasets/ANONYMIZED/DATASET/lam_sweep_mlp_sp.csv
...
MUC DICH KHOA HOC (khong doi):
  Quet damping cho dev_rel trong che do SP (MLP/MNIST).
...
DAU RA:
  lam_sweep_mlp_sp.csv        theo cap (resumable)
  lam_sweep_mlp_sp_cell.csv   median theo o
  + BAO CAO cuoi log: bang so mu 3 lambda, do tut theo cap, mu_eff/lambda,
    va VERDICT.

CAN CO:
  ckpt_pmlp_v2/sp_{act}_w{w}_s{s}.pt   va  MNIST tai ./data
...
MODE      = "mlp"
RUN_TAG   = "pmlp_v2"
REGIMES   = ["sp"]                # <-- CHO DUY NHAT khac 2 file kia
...
OUT_NAME  = "lam_sweep_mlp_sp.csv"
ALT_NAMES = []                # ten cu khac cua CHINH file nay, neu co
OUT_CSV   = os.path.join(OUT_DIR, OUT_NAME)
CELL_CSV  = os.path.join(OUT_DIR, "lam_sweep_mlp_sp_cell.csv")
